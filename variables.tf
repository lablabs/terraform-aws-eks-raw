...
variable "namespace" {
  type        = string
  default     = "raw"
  description = "The K8s namespace in which the raw service account has been created"
}

variable "settings" {
  type        = map(any)
  default     = {}
  description = "Additional helm sets which will be passed to the Helm chart values, see https://artifacthub.io/packages/helm/main/raw"
}

variable "values" {
  type        = string
  default     = ""
  description = "Additional yaml encoded values which will be passed to the Helm chart, see https://artifacthub.io/packages/helm/main/raw"
}
...
variable "service_account_name" {
  type        = string
  default     = "raw"
  description = "The k8s raw service account name"
}
...
variable "irsa_role_name_prefix" {
  type        = string
  default     = "raw-irsa"
  description = "The IRSA role name prefix for raw"
}
